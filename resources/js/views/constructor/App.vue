<template>
        ...
        <div id="wrapper" v-if="imagesData && options" >

            <VOptionsMenu :menu="menu" :imagesData="imagesData" :options="options"></VOptionsMenu>

            <VOptions :menu="menu" :imagesData="imagesData" :options="options"></VOptions>
...
<script>
    ...
    export default {
        name: 'app',
        props: ['imagesData', 'textAreas', 'sizes', 'lists', 'options'],
